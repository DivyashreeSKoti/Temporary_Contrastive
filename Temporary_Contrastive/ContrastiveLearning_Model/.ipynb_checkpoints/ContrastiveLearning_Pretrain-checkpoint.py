...
train_subsampled_dataloader = DL.CustomDataLoader(train_data, train_targets, batch_size=batch_size, num_batches=150, subsample_size=subsample_size, shuffle=True)
...
masked_encoder_model = fp+'/saved_models/files99'+'/masked_encoder_'+str(embed_dim)+'_'+str(num_heads)+'_'+str(num_induce)+'_'+str(stack)+'_'+str(dropout)+'.pth'
unmasked_encoder_model = fp+'/saved_models/files99'+'/unmasked_encoder_'+str(embed_dim)+'_'+str(num_heads)+'_'+str(num_induce)+'_'+str(stack)+'_'+str(dropout)+'.pth'
